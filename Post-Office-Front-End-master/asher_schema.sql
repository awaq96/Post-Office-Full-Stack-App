...
CREATE TABLE `employee` (
  ...
  `vacation_status` varchar(45) DEFAULT NULL,
  PRIMARY KEY (`employee_id`),
  KEY `office_fk_idx` (`office_id`),
  CONSTRAINT `office_fk` FOREIGN KEY (`office_id`) REFERENCES `office` (`off_id`)
...
INSERT INTO `employee` VALUES (24,4,0,'12345',NULL,' Monday',111,'2020-01-01','Vacation Approved'),(25,4,0,'12345',NULL,'Monday',111,'2020-02-01','Vacation Approved'),(26,4,0,'123',NULL,' Monday',111,NULL,'Vacation Denied');
...
-- Dump completed on 2020-04-20  0:27:11
